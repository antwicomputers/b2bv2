...
class EditYouthResourceScreen extends StatefulWidget {
  final Support support;
  const EditYouthResourceScreen({super.key, required this.support});

  @override
  State<EditYouthResourceScreen> createState() => _EditYouthResourceScreenState();
}

class _EditYouthResourceScreenState extends State<EditYouthResourceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Edit Youth Resource'),
        centerTitle: true,
      ),
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                        label: Text('Enter Resource Description'),
                  ...
                  Consumer<UserProvider>(
                    builder: (context, value, child) => ElevatedButton(
                      onPressed: () async {
                        ...
                        String message = await value.updateYouthResource(
