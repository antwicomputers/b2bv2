        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: const Text('Share a Resource', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
              background: Container(
                ...
                child: const Center(
                  child: Opacity(
                    opacity: 0.12,
                    child: Icon(Icons.share_location, size: 100, color: _silver),
                  ),
                ),
              ),
            ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const _SectionHeader(icon: Icons.info_outline, title: 'Resource Information'),
                    const SizedBox(height: 12),
                    _FormCard(
                      children: [
                        _StyledField(controller: _businessName, label: 'Resource Name', icon: Icons.monetization_on, required: true),
                        _divider(),
                      ...
                      builder: (context, value, child) => GestureDetector(
                        onTap: _isLoading
                            ...
                            : () async {
                                ...
                                String message = await value.userRegister(
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Center(
                            child: _isLoading ? const SizedBox(height: 22, width: 22, child: CircularProgressIndicator(strokeWidth: 2.5, color: Colors.black)) : const Text('Submit Resource', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 16, letterSpacing: 0.5)),
                          ),
                        ),
                      ),
                    ),
