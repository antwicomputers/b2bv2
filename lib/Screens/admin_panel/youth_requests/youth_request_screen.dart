...
class YouthRequestScreen extends StatefulWidget {
  const YouthRequestScreen({super.key});

  @override
  State<YouthRequestScreen> createState() => _YouthRequestScreenState();
}

class _YouthRequestScreenState extends State<YouthRequestScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Manage Youth Resources', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        leading: IconButton(
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Search youth resources...',
      ...
      body: Container(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('youthresource').snapshots(),
          builder: (context, snapshot) {
            ...
            if (docs.isEmpty) {
              return const Center(child: Text('No youth resources found', style: TextStyle(color: Colors.white38)));
            }
