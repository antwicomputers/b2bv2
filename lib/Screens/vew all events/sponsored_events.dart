...
class SponsoredEvents extends StatefulWidget {
  const SponsoredEvents({Key? key}) : super(key: key);

  @override
  State<SponsoredEvents> createState() => _ViewAllEventsScreenState();
}

class _ViewAllEventsScreenState extends State<SponsoredEvents> {
  @override
      ...
      child: Consumer<UserProvider>(
        builder: (context, value, child) => Scaffold(
          appBar: AppBar(
            ...
            title: const Text('Sponsored Events'),
          ),
          body: StreamBuilder(
